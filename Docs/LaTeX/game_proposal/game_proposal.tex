...
StickMatch is a 3D fighting game for {\it Linux}, {\it Windows}, {\it Xbox},
and {\it Pandora}.  The goal of the game is to Knock Out [KO] your opponent via
...
\path [line] (contleft) -| node[xshift=-1.5cm,yshift=-0.25cm] {No}([xshift=0.5cm]npp.east) |-(start);
\path [line] (npp) |- (stagen);
\path [line] (continue) -| node [xshift=1cm,yshift=-0.25cm]{Yes}([xshift=-1.5cm]continue.west) |-(stagen);
\path [line] (continue) -| node [xshift=-1.5cm,yshift=-0.25cm]{No}([xshift=0.5cm]npp.east) |-(start);
